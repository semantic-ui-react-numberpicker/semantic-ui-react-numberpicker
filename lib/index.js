...
var NumberPicker = _react2.default.createClass({
    ...
    handleAction: function handleAction(event, v) {
        ...
        var setVal = _lodash2.default.isFinite(parseFloat(this.props.value)) ? parseFloat(this.props.value) : this.props.defaultValue;
    ...
    validateInput: function validateInput(event, v) {
        ...
        switch (actionFilter) {
            case this.props.name:
                ...
                setVal = _lodash2.default.isFinite(parsedVal) ? parsedVal : this.props.defaultValue;

                if (this.props.value > this.props.max) setVal = this.props.max;
                break;
